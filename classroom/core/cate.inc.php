...
function getCateById($id){
	$sql="select id,cName from room_cate where id={$id}";
	return fetchOne($sql);
}
 ...
 */
function getAllCate(){
	$sql="select id,cName from room_cate";
	$rows=fetchAll($sql);
	return $rows;
}
