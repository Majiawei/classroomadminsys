...
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	<tr>
		...
		<td><input type="text" name="pName"  placeholder="请输入教室名称"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right">教室号</td>
		<td><input type="text" name="pSn"  placeholder="请输入教室号"/></td>
	</tr>
	<tr>
...
<!-- 	</tr> -->
	...
	<tr>
		<td colspan="2"><input type="submit"  value="添加教室"/></td>
	</tr>
</table>
</form>
</body>
