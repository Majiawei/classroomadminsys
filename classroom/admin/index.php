    ...
    <div class="content clearfix">
        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    <li>
                        <h3><span onclick="show('menu1','change1')" id="change1">+</span>教室管理</h3>
                        <dl id="menu1" style="display:none;">
                        	<dd><a href="addPro.php" target="mainFrame">添加教室</a></dd>
                            <dd><a href="listPro.php" target="mainFrame">教室列表</a></dd>
                        </dl>
                    </li>
                    <li>
